(function() {
    ...
    const PAGE_SIZE = 50;
    const SUPER_ADMIN_SECRET = '413335259';  // 保留硬编码密钥
    ...
    // 获取聚合统计（通过rpc函数，需提前创建 get_station_counts）
